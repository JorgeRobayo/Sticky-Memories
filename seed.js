...
(async function() {
  ...
  const items = await Item.create([
    {name: 'Hamburgersa', emoji: '🍔', category: categories[2], price: 5.95},
    ...
    {name: '4 x 4', emoji: '🍳', category: categories[0], price: 5.95},
    {name: '7 x 5', emoji: '🍩', category: categories[0], price: 5.95},
    {name: '8 x 10', emoji: '🥪', category: categories[0], price: 6.95},
